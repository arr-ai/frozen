...
func (b *branch) CopyTo(dest []kv.KeyValue) []kv.KeyValue {
...
func (b *branch) Iterator(buf [][]node) kvi.Iterator {
...
func (b *branch) Transform(args *CombineArgs, depth int, count *int, f func(e kv.KeyValue) kv.KeyValue) node {

...
// 	b.root.node = b.root.x().with(withKeyArgs, kv, 0, newHasher(kv, 0), &b.redundantPuts)
// 	b.attemptedAdds++
// }
...
// 	kv := StringKV(key, nil)
// 	b.root.node = b.root.x().without(&equalKeyArgs, kv, 0, newHasher(kv, 0), &b.removals)
// }
...
// 	var matches int
// 	if entry := b.root.get(&equalArgs, StringKV(key, nil), &matches); entry != nil {
...
// 	root := b.root
// 	*b = StringMapBuilder{}
// 	return StringMap{root: root.x(), count: count}
// }
